...
После обработки файла программа выводит спискок ICAO-адресов с датой и временем (зоны UTC и МСК), когда борт появился и пропал в виде таблицы и показывает, передавал ли борт координаты
...
```
4. Запустить в терминале программу с указанием файла:
```
